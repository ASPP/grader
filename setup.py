...
This setup.py is based on the template at the PyPA sample project. See:
...
setup(
    ...
    # Author details
    author='ASPP Contributors',
    author_email='python@g-node.org',
    ...
    # Check packaging.python.org for details on this format
    package_data={
    ...
    # script_name=package_name.module:function_name ] }
    entry_points={
        'console_scripts': [
